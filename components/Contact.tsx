...
//       href: "https://wa.me/6281336223130",
//     },
//     {
//       label: "Instagram",
//       value: "@swatu.design",
...
//       <div className="grid grid-cols-2 gap-20 max-w-4xl mx-auto px-12">
//         {/* Contact info */}
//         <div className="pt-2">
//           {contactItems.map((item) => (
//             <div
//               key={item.label}
//               className="mb-8 pb-8 border-b border-white/8 last:border-0 last:mb-0 last:pb-0"
//             >
...
//                 className="font-serif text-lg font-light text-white hover:text-warm-light transition-colors duration-200 leading-snug"
//               >
//                 {item.value}
//               </a>
//             </div>
...
//                 className="bg-white/6 border border-white/12 text-black placeholder-white/20 px-4 py-3 text-sm font-sans outline-none focus:border-warm-light transition-colors duration-200"
//                 required
//               />
//             </div>
//           ))}
...
//               className="bg-white/6 border border-white/12 text-black placeholder-white/20 px-4 py-3 text-sm font-sans outline-none focus:border-warm-light transition-colors duration-200 resize-y"
//               required
//             />
//           </div>
...
//           <button
//             type="submit"
//             className="self-start bg-warm text-white border border-warm px-8 py-3.5 text-[11px] tracking-[0.16em] uppercase font-sans hover:bg-transparent hover:text-warm-light transition-all duration-250 mt-2"
//           >
//             Send Inquiry
//           </button>
//         </form>
