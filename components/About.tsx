...
//   const locations = ["Yogyakarta", "Jakarta", "Tangerang", "Bali", "Semarang", "Bogor"];

//   return (
//     <section id="about" className="bg-cream py-24" style={{ scrollMarginTop: "80px" }}>
//       <div className="grid grid-cols-2 gap-20 items-center max-w-5xl mx-auto px-12">
...
//           <blockquote className="font-serif text-lg font-light italic text-charcoal border-l-2 border-warm-light pl-6 mb-8 leading-relaxed">
...
//                 <p className="text-sm leading-[1.85] text-[#6b6b68] font-sans">{v}</p>
//               </div>
//             ))}
//           </div>
...
//               <span
//                 key={loc}
//                 className="text-[11px] tracking-[0.12em] uppercase text-sage-dark border border-sage-light px-4 py-1.5 font-sans"
//               >
//                 {loc}
//               </span>
//             ))}
...
//               >
//                 <span
//                   className={`font-serif text-center text-base leading-snug ${
...
//           {/* Address card */}
//           <div className="mt-0.5 bg-[#f0ece4] px-6 py-5">
...
//               Bleber Kidul RT 06 RW 17,<br />
//               Sumberharjo, Prambanan, Sleman,<br />
